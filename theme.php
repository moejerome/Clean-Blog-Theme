...
class clean extends Theme
{
	...
	public function action_add_template_vars($theme) {
		...
		//Add Stylesheets
		Stack::add('template_stylesheet', array($this->get_url( '/css/bootstrap.min.css' )), 'reset');
		Stack::add('template_stylesheet', array($this->get_url(  '/css/clean-blog.min.css' )), 'main', 'reset');
